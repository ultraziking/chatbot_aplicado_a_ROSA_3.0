            ...
            try:                              
                ...
                with sr.Microphone() as source:   
                    ...
                    if user_input == "chatear":
                        ...
                        salida.runAndWait()
                        #t2 = threading.Thread(target=chat, args=(1,))
                        #t2.daemon = True
                        #t2.start()
                        chat(1)
                        ...
                        salida.runAndWait()
                        #t3 = threading.Thread(target=interaccion, args=(1,))
                        #t3.daemon = True
                        #t3.start()
                        interaccion(1)
                        ...
                        salida.runAndWait()
                        #t4 = threading.Thread(target=consulta, args=(1,))
                        #t4.daemon = True
                        #t4.start()
                        consulta(1)
                    else:
            ...
            try:
                with sr.Microphone() as source: 
                    ...
                    if inpu =="adios" or inpu =="adiós":
                        ...
                        salida.runAndWait()
                        #t5 = threading.Thread(target=interaccion, args=(1,))
                        #t5.daemon = True
                       # t5.start()
                        x == 2
                        interaccion(1)
...
def startchatbot():
    ...
    flag_chatbot = True
        ...
        #p = Process(target = sayhola)
        #p.start()
    #t1 = threading.Thread(target=chatbot, args=(1,))
    #t1.daemon = True
    #t1.start()
    chatbot(1)
...
def stopchatbot():
    ...
    flag_chatbot = False
    #if __name__ == '__main__':
        #q = Process(target=sayhola)
        #q.start()
    #t2 = threading.Thread(target=chatbot, args=(2,))
    #t2.start()
    chatbot(2)
    print("end chatbot")
